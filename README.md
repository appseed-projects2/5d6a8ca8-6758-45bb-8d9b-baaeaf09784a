...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-09 07:02`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5d6a8ca8-6758-45bb-8d9b-baaeaf09784a.git
$ cd 5d6a8ca8-6758-45bb-8d9b-baaeaf09784a
```
